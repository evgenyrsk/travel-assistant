...
Этот документ фиксирует актуальную продуктовую основу Travel Assistant после завершения Stage 0–11 и пересогласования функционального MVP в Stage 12.0–12.1a. Текущий статус этапов, последний завершенный шаг и следующий разрешенный шаг фиксируются только в `docs/roadmap/roadmap.md`.
