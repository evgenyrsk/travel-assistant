...
Этот документ фиксирует актуальную продуктовую основу Travel Assistant после завершения Stage 0–11 и пересогласования функционального MVP в Stage 12.0. Текущий статус этапов, последний завершенный шаг и следующий разрешенный шаг фиксируются только в `docs/roadmap/roadmap.md`.
...
- Stage 12.0 - пересогласовал текущий демонстрационный MVP вокруг итеративного уточнения hotel search; подробный статус Stage 12 находится только в roadmap.
...
показала первые 5. Stage 12.0 развивает этот срез через повторное уточнение
необязательных предпочтений и новый подтвержденный provider search. Это не
означает production readiness или готовность будущих продуктовых клиентов.
...
- итеративное уточнение в чате максимальной общей стоимости, звезд,
  минимального гостевого рейтинга и обязательной бесплатной отмены;
- выбор сортировки: рекомендуемая, сначала дешевле или сначала с лучшим
  рейтингом;
