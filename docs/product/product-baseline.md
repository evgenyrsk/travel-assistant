...
Этот документ фиксирует актуальную продуктовую основу Travel Assistant после завершения Stage 0–11 и последующей документационной синхронизации. Текущий статус этапов, последний завершенный шаг и следующий разрешенный шаг фиксируются только в `docs/roadmap/roadmap.md`.
...
показала первые 5. Это не означает полную реализацию MVP v1, production
readiness или готовность будущих продуктовых клиентов.
