...
| Следующий планируемый шаг | Stage 16.7 — observability, evaluation и closure |
...
**Статус:** активен; Stage 16.6 завершён.
...
| Stage 16.7 | Observability, evaluation и closure | Следующий разрешённый шаг; REAL smoke допускается только после policy/model gates и без automatic retry |
