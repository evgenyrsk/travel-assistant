...
Этот документ задает правила работы с задачами для Travel Assistant. Он нужен, чтобы развитие продукта шло маленькими проверяемыми шагами, а архитектура оставалась пригодной для web, mobile, desktop и будущих интеграций с провайдерами. Актуальный статус этапов, чеклисты артефактов и следующий шаг фиксируются в primary roadmap: `docs/roadmap/roadmap.md`.
