...
Примеры хорошего разбиения для будущей явно разрешенной implementation/API задачи. Этот список не является текущим backlog и не активирует работу над contract/code:
