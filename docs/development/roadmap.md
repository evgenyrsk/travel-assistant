...
**Файлы и модули:** `docs/PROJECT_BRIEF.md`, будущие `docs/product/requirements.md`, `docs/product/user-flows.md`.
...
**Файлы и модули:** `docs/product/mvp-scope.md`, roadmap, milestones.
...
**Файлы и модули:** `docs/ARCHITECTURE.md`, будущие `services/backend/`, `app/web/`, `docs/architecture/`.
