...
установку, раздельное/совместное подключение и versioned contracts. Публичный
набор `0.30.0/0.17.0/0.16.0` с Hotels checkout inspection прошёл bounded smoke,
независимый review, registry upload и fresh-install initialize без активации
booking/payment или quote mutations.
...
| --- | --- | --- |
| Hotels MCP | Node.js 20+, `stdio`, package bin, protocol `2025-03-26`; anonymous read-only search; `0.30.0` опубликована и проверена fresh-install initialize | Нет checksums/SBOM/provenance и полной OS/client matrix |
