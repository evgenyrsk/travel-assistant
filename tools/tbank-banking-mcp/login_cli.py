...
from src.session_store import DEFAULT_SESSION_PATH, blank_session, exclusive_session_lock, write_session
from src.upstream.client import TbankApiError
...
def main() -> int:
    ...
    if len(sys.argv) == 1:
        ...
        print("Usage: python login_cli.py [+7XXXXXXXXXX] | --logout")
        return 2
